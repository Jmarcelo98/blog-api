...
public class FollowerController {
	...
	public ResponseEntity<List<FollowersOutputDTO>> findAllFollowers(@PathVariable("nickname") String nickname) {
		return ResponseEntity.ok(followerService.findAllFollowers(nickname));
	}

	@GetMapping(value = "/all-following/{nickname}")
	public ResponseEntity<List<FollowingOutputDTO>> findAllFollowing(@PathVariable("nickname") String nickname) {
